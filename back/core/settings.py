...
SECRET_KEY = "django-insecure-08cl1@!52e_oa&0tc!pzrjk2elq^xmoln1avtt^*2$orq0&bfz"
...
SIMPLE_JWT = {
    ...
    # "USER_ID_FIELD": "user_name", => this will return username in 'USER_ID_CLAIM' in JWT Instead of 'ID'
    "USER_ID_FIELD": "id",
