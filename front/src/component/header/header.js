          ...
          (dataAuth.isAuthenticated !== true) ?
            <>
              <div id='nav-links' className='nav-links d-flex gap-3'>
                <Link to='/login' className='login d-flex gap-1 justify-content-center align-items-center' dir='rtl'>
                ...
                <RedMainBtn to='/register' name='انشاء حساب' id='register' icon={home_icon} />
              </div>
            </>
